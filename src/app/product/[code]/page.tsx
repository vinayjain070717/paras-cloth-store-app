...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen pb-24">
      {/* Top bar */}
      <div className="sticky top-0 z-40 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md flex items-center justify-between px-3 py-2 max-w-5xl mx-auto">
      ...
      <div className="max-w-5xl mx-auto lg:flex lg:gap-6 lg:px-4 lg:py-6">
        {/* Left column: Image Gallery */}
        <div className="lg:w-1/2 lg:shrink-0">
          <div className="relative bg-white dark:bg-gray-800 lg:rounded-xl lg:overflow-hidden lg:sticky lg:top-14">
            <div className="overflow-x-auto snap-x snap-mandatory flex hide-scrollbar" onScroll={(e) => {
              ...
              {images.length > 0 ? images.map((img, i) => (
                <div key={i} className="w-full shrink-0 snap-center aspect-square lg:max-h-[70vh] relative">
        ...
        <div className="lg:w-1/2">
          <div className="px-4 py-4 space-y-3 lg:px-0">
            ...
            <p className="text-2xl lg:text-3xl font-bold" style={{ color: "var(--theme-primary)" }}>
      ...
      {similar.length > 0 && (
        <section className="px-4 mt-4 max-w-5xl mx-auto">
      ...
      {product.is_available && (
        <div className="fixed bottom-0 left-0 right-0 p-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md border-t border-gray-200 dark:border-gray-700 z-40">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full max-w-5xl mx-auto py-3.5 rounded-full bg-green-500 hover:bg-green-600 text-white font-bold text-base transition-colors shadow-lg"
          >
